...
#Setting up font, sounds and images
...
drawtext('Developed by Srikar Varma', scorefont, Canvas, 450, window_height - 50)
...
while True:
    ...
    while True:                 #the main game loop
        ...
        drawtext('Score : %s | Top score : %s | Level : %s' %(player.score, topscore, level), scorefont, Canvas, 425, cactusrect.bottom + 10)
        drawtext('Developed by Srikar Varma', scorefont, Canvas, 450, firerect.top - 10)
